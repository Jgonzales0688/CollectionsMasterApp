    ...
    class Program
    {
        ...
        //    Utlilize the method stubs at the bottom for the methods you must create ⬇⬇⬇
            ...
            */
            ...
            Console.WriteLine($"Origingal Capacity: {numberList.Capacity}");
            ...
            do
            {
                Console.WriteLine("What number will you search for in the number list? Please enter your number!");
                notAbc = int.TryParse(Console.ReadLine(), out userInput);
            ...
            int[] convert = numberList.ToArray();
            NumberPrinter(numberList);
            //TODO: Clear the list
            numberList.Clear();
